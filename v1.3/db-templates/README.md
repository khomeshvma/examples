Digital Garage Database Examples
=============================

This directory contains example JSON templates to deploy databases in the Digital Garage.
...
"[emptyDir](http://docs.thedigitalgarage.io/dev_guide/volumes.html)" volumes
...
claims](http://docs.thedigitalgarage.io/architecture/additional_concepts/storage.html#persistent-volume-claims)
to request persistent storage provided by [persistent
volumes](http://docs.thedigitalgarage.io/architecture/additional_concepts/storage.html#persistent-volumes),
...
local path or an URL. Example:
    ...
    $ oc new-app https://raw.githubusercontent.com/thedigitalgarage/examples/master/db-templates/mongodb-ephemeral-template.json
...
want to load the template into a Digital Garage project so that it can be used
...
local path or an URL. Example:
    ...
    $ oc create -f https://raw.githubusercontent.com/thedigitalgarage/examples/master/db-templates/mongodb-ephemeral-template.json
...
- [MySQL](http://docs.thedigitalgarage.io/using_images/db_images/mysql.html)
- [PostgreSQL](http://docs.thedigitalgarage.io/using_images/db_images/postgresql.html)
- [MongoDB](http://docs.thedigitalgarage.io/using_images/db_images/mongodb.html)
